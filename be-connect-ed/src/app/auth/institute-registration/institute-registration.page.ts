...
@Component({
 selector: 'app-institute-registration',
  templateUrl: './institute-registration.page.html',
  styleUrls: ['./institute-registration.page.scss'],
  standalone: false
})
export class InstituteRegistrationPage implements OnInit {
