...
@Component({
selector: 'app-ind-student-profile',
  templateUrl: './ind-student-profile.page.html',
  styleUrls: ['./ind-student-profile.page.scss'],
  standalone: false,
})


export class IndStudentProfilePage implements OnInit {
name = '';
surname = '';
role='';
